(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("lodash.omit"), require("lodash.mapvalues"), require("lodash.has"), require("redux"), require("react"), require("uuid"), require("lodash.isplainobject"), require("lodash.isnil"), require("lodash.get"), require("lodash.flowright"), require("react-redux"));
	else if(typeof define === 'function' && define.amd)
		define(["lodash.omit", "lodash.mapvalues", "lodash.has", "redux", "react", "uuid", "lodash.isplainobject", "lodash.isnil", "lodash.get", "lodash.flowright", "react-redux"], factory);
	else if(typeof exports === 'object')
		exports["ReactReduxUUID"] = factory(require("lodash.omit"), require("lodash.mapvalues"), require("lodash.has"), require("redux"), require("react"), require("uuid"), require("lodash.isplainobject"), require("lodash.isnil"), require("lodash.get"), require("lodash.flowright"), require("react-redux"));
	else
		root["ReactReduxUUID"] = factory(root["lodash.omit"], root["lodash.mapvalues"], root["lodash.has"], root["redux"], root["react"], root["uuid"], root["lodash.isplainobject"], root["lodash.isnil"], root["lodash.get"], root["lodash.flowright"], root["react-redux"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var wrapActionCreators = exports.wrapActionCreators = function wrapActionCreators(actionCreator, name, uuid) {
	  ...
	  function augmentDispatch(dispatch) {
	    return (0, _lodash10.default)(dispatch, wrapAction);
	  }
