(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("lodash.omit"), require("lodash.mapvalues"), require("lodash.has"), require("redux"), require("react"), require("uuid"), require("lodash.isplainobject"), require("lodash.isobjectlike"), require("lodash.isnil"), require("lodash.get"), require("react-redux"));
	else if(typeof define === 'function' && define.amd)
		define(["lodash.omit", "lodash.mapvalues", "lodash.has", "redux", "react", "uuid", "lodash.isplainobject", "lodash.isobjectlike", "lodash.isnil", "lodash.get", "react-redux"], factory);
	else if(typeof exports === 'object')
		exports["ReactReduxUUID"] = factory(require("lodash.omit"), require("lodash.mapvalues"), require("lodash.has"), require("redux"), require("react"), require("uuid"), require("lodash.isplainobject"), require("lodash.isobjectlike"), require("lodash.isnil"), require("lodash.get"), require("react-redux"));
	else
		root["ReactReduxUUID"] = factory(root["lodash.omit"], root["lodash.mapvalues"], root["lodash.has"], root["redux"], root["react"], root["uuid"], root["lodash.isplainobject"], root["lodash.isobjectlike"], root["lodash.isnil"], root["lodash.get"], root["react-redux"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodash9 = __webpack_require__(17);
	...
	var getUUIDState = exports.getUUIDState = function getUUIDState(state, name) {
	  ...
	  return (0, _lodash10.default)(state, ['uuid', name].concat(args));
	};
	...
	var wrapActionCreators = exports.wrapActionCreators = function wrapActionCreators(actionCreator, name, uuid) {
	  ...
	  if ((0, _lodash6.default)(actionCreator)) {
	  ...
	  function augmentDispatch(dispatch) {
	    return (0, _redux.compose)(dispatch, wrapAction);
	  }
	...
	var wrapMapStateToProps = exports.wrapMapStateToProps = function wrapMapStateToProps(mapStateToProps, name) {
	  return function (state, props) {
	    if ((0, _lodash8.default)(mapStateToProps)) return {};
	...
	var wrapMapDispatchToProps = function wrapMapDispatchToProps(mapDispatchToProps, name) {
	  return function (dispatch, _ref3) {
	    ...
	    if ((0, _lodash8.default)(mapDispatchToProps)) return {};
	    if ((0, _lodash6.default)(mapDispatchToProps)) {
